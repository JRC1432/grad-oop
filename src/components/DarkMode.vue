<template>
  <div class="q-pa-xs">
    <q-btn flat round @click="changetheme">
      <IconSunFilled :size="30" stroke-width="2" v-if="isMoonStars" />
      <IconMoonFilled v-else :size="30" stroke-width="2" />
...
import { IconMoonFilled, IconSunFilled } from '@tabler/icons-vue'
